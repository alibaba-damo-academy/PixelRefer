...
import sys
sys.path.append(".")
from pixelrefer.constants import DEFAULT_IMAGE_TOKEN, IGNORE_INDEX
...
class PixelreferProcessorKwargs(ProcessingKwargs, total=False):
    _defaults = {
        "text_kwargs": {
            "padding": False,
        },
...
class PixelreferProcessor(ProcessorMixin):
    r"""
    ...
    def __call__(
        ...
        image_downsampling: Optional[int] = None,
        return_labels: bool = False,
        **kwargs: Unpack[PixelreferProcessorKwargs],
    ) -> BatchFeature:
        """
