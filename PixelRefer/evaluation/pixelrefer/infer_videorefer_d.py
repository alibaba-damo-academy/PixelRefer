...
class VideoRefer_Bench_D(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question = "<video>\nPlease describe in detail the marked object <region> in the video."
        ...
        # video_tensor = load_video(video_path, fps=None, max_frames=32, frame_ids=frame_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video-folder', help='Directory containing video files.', default='benchmarks/VideoRefer-Bench/Panda-70M-part')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='benchmarks/VideoRefer-Bench/VideoRefer-Bench-D.json')
