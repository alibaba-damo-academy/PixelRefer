...
class Ferret(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.exists(os.path.join(self.image_folder, 'train2017', line['image'])):
            ...
            os.path.exists(os.path.join(self.image_folder, 'val2017', line['image']))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='benchmarks/ferret-bench/box_refer_reason.json')
