...
class PACO_LVIS(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if os.path.exists(os.path.join(self.image_folder, 'train2017', line['image'])):
            ...
            image_file = os.path.exists(os.path.join(self.image_folder, 'val2017', line['image']))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model-path', help='', default='work_dirs/PixelRefer-2B')
    parser.add_argument('--image-folder', help='Directory containing video files.', default='COCO/train2017')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='benchmark/lvis_val_1k_category.json')
