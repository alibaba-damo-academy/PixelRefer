...
class REFCOCOG(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question = 'Please describe <region> briefly.'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--image-folder', help='Directory containing video files.', default='data/')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='benchmark/vg_val_5000.json')
