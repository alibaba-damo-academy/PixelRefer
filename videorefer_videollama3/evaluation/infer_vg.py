...
if __name__ == "__main__":
    ...
    parser.add_argument('--image-folder', help='Directory containing video files.', default='VG/')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='vg_val_5000.json')
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default='./eval/vg/output.json')
