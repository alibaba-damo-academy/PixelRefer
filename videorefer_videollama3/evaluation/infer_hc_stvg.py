...
class HC_STVG(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        question = "<video>\nPlease describe the important aspects of the marked object <region> in the video. Output in one sentense."
        ...
        video_tensor = load_video(video_path, fps=4, max_frames=768, frame_ids=frame_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--video-folder', help='Directory containing video files.', default='HC-STVG/video_parts')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='hc_stvg_eval.json')
