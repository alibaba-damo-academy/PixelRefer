...
if __name__ == "__main__":
    ...
    parser.add_argument('--image-folder', help='Directory containing video files.', default='Ref-L4/images')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='ref-l4-val.json')
    parser.add_argument('--output-file', help='Directory to save the model results JSON.', default='./eval/ref-l4/output.json')
