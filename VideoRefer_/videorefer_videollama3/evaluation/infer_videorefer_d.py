...
if __name__ == "__main__":
    ...
    parser.add_argument('--video-folder', help='Directory containing video files.', default='Panda-70M-part')
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='VideoRefer-Bench-D.json')
