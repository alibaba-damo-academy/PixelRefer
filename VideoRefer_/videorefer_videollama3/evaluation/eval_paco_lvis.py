...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate paco-lvis.")
    parser.add_argument("--pred-path", default=r'', help="The path to file containing prediction.")
    parser.add_argument("--bert-model", default='all-MiniLM-L6-v2', help="The path to file containing prediction.")
