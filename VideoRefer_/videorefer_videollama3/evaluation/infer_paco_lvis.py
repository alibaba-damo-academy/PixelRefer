...
import sys
sys.path.append('./')
from videorefer_videollama3 import disable_torch_init, model_init, get_model_output
...
from videorefer_videollama3.mm_utils import load_images
...
if __name__ == "__main__":
    ...
    parser.add_argument('--question-file', help='Path to the ground truth file containing question.', default='lvis_val_1k_category.json')
